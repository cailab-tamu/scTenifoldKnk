...
dirDR <- read.csv('../dirResults/dirTREM2.csv', row.names = 1)
...
png('../dirResults/GSE130626.png', width = 2000, height = 2000, res = 300)
plotDR(GSE130626)
dev.off()

png('../dirResults/ego_GSE130626.png', width = 3000, height = 3000, res = 300, bg = NA)
plotKO(GSE130626, gKO = 'Trem2')
dev.off()
...
png('../dirResults/gsea1_GSE130626.png', width = 1000, height = 1000, res = 300)
...
png('../dirResults/gsea2_GSE130626.png', width = 1000, height = 1000, res = 300)
...
png('../dirResults/gsea3_GSE130626.png', width = 1000, height = 1000, res = 300)
gSet <- 'Lysosome'
plotEnrichment(MGI[[gSet]], zGSE130626) +
  labs(
    title = gSet,
